...
# 1. Efficiency Score (60%): Reward the average size.
    # > 69 acres = 4 points (Utility Scale)
    # 20-25 acres = 3 points (Community Scale)
    # 10–20 acres = 2 points (Standard)
    # >10 acres = 1 points (Marginal)
