...
The analysis utilizes a geospatial MCDA framework to identify optimal co-location zones by integrating:
    ...
    - Administrative Boundaries (1997): Aggregating potential by municipal jurisdiction. 
